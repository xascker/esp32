...
if __name__ == '__main__':
    ...
    icon_display.draw_icon(250, 50, wind_32x32, image4Gray=False)
    icon_display.draw_icon(305, 50, sunrise_32x32, image4Gray=False)
    icon_display.draw_icon(360, 50, sunset_32x32, image4Gray=False)
    ...
    #epd.image4Gray.text(weather.wind_direction_to_cardinal(wind_direction), 250, 98, epd.black)
